...
public:
  ...
  ExplicitSolver(const std::string  &mesh_file_name_,
...
protected:
  ...
  // Matrix on the left-hand side (M / deltat).
  TrilinosWrappers::SparseMatrix lhs_matrix;

  // Matrix on the right-hand side (M / deltat - A).
